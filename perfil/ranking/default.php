...
?>
    <title>Ranking</title>
    <style><?php include('../../public/resources/css/rankingP.css')?></style>
...
<body>
    ...
    <main>
        <aside id="menu">
            ...
            <a title="Ranking" class="option active">
                <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="mainContent" class="row container-fluid">
                ...
                <div id="leftSide" class="col-12 col-lg-3">
                    <div id="box1" class="box">
                        <h2>Tus rankings <?php echo date('Y');?></h2>
                        <div id="rankingItemsContainer">
                ...
                <div id="rightSide" class="col">
                    <div id="box3" class="box">
                        ...
                        <div id="rankingResultsContainer">
    ...
    <script> <?php include('../../public/resources/js/rankingP.js'); ?> </script>
