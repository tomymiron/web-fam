...
?>
    ...
    <style><?php include('../../public/resources/css/competitionP.css')?></style>
...
<body>
            ...
            <div id="mainContent" class="row container-fluid">
                ...
                <div id="leftSide" class="col-12 col-lg-5 col-xl-4">
                    <div id="box1" class="box">
                        ...
                        <div id="box1Content">
                            <div id="box1ContentAuxiliar">
                                <?php
                                $sql = "select competitions.name, competitions.date, group_concat(disciplines.name SEPARATOR '</p><p>') as 'disciplines' from competitions left join events on events.ID_competition = competitions.ID_competition left join disciplines on disciplines.ID_discipline = events.ID_discipline left join inscriptions on inscriptions.ID_event = events.ID_event where competitions.date > curdate() and competitions.public = 1 and inscriptions.ID_athlete = " . $user['ID_athlete'] . " group by competitions.ID_competition order by competitions.date ASC;";
                                        ...
                                        <div class="pComp">
                                            <div class="pComp1">
                                                <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M16.7423 5.95825C14.3763 5.95825 12.4583 7.87632 12.4583 10.2423V21.6666C12.4583 29.1455 18.5211 35.2082 25.9999 35.2082C33.4788 35.2082 39.5416 29.1455 39.5416 21.6666V10.2423C39.5416 7.87632 37.6234 5.95825 35.2574 5.95825H16.7423Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                                    <path d="M26 36.8333V38.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round"/>
                                                    <path d="M32.5001 40.625H19.5001C18.0043 40.625 16.7917 41.8376 16.7917 43.3333C16.7917 44.8291 18.0043 46.0417 19.5001 46.0417H32.5001C33.9959 46.0417 35.2084 44.8291 35.2084 43.3333C35.2084 41.8376 33.9959 40.625 32.5001 40.625Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                                    <path d="M11.9167 10.8333C8.92513 10.8333 6.5 13.2584 6.5 16.2499V16.9615C6.5 18.5868 7.14564 20.1456 8.29493 21.2949L13 25.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M40.0833 10.8333C43.0749 10.8333 45.5 13.2584 45.5 16.2499V16.9615C45.5 18.5868 44.8543 20.1456 43.7051 21.2949L39 25.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                                <div>
                                                    <p class="pCompeName"><?php echo($row['name']);?></p>
                                                    <p class="pCompDate"><?php echo($row['date']);?></p>
                                                </div>
                                            </div>
                                            <div class="pComp2">
                                                <p><?php echo($row['disciplines']);?></p>
                                            </div>
                                        </div>
                                <?php }}else{ echo('<p>No hay competencias pendientes</p>');} ?>
                            </div>
                        </div>
                    </div>
                    <div id="box2" class="box">
                        <h2>Competencias finalizadas</h2>
                        <div>
                            <?php
                                $sql = "select * from competitions where public = 1 and addtime(current_timestamp(),'24:00:00') > competitions.date order by competitions.date DESC limit 15;";
                                $result = $conn->query($sql);
                                while($row = $result->fetch_assoc()){ $competitionContainer = $row['ID_competition']; ?>

                            <div class="eComp">
                                <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.7423 5.95825C14.3763 5.95825 12.4583 7.87632 12.4583 10.2423V21.6666C12.4583 29.1455 18.5211 35.2082 25.9999 35.2082C33.4788 35.2082 39.5416 29.1455 39.5416 21.6666V10.2423C39.5416 7.87632 37.6234 5.95825 35.2574 5.95825H16.7423Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                    <path d="M26 36.8333V38.9999" stroke="#edf2fb" stroke-width="1.5" stroke-linecap="round"/>
                                    <path d="M32.5001 40.625H19.5001C18.0043 40.625 16.7917 41.8376 16.7917 43.3333C16.7917 44.8291 18.0043 46.0417 19.5001 46.0417H32.5001C33.9959 46.0417 35.2084 44.8291 35.2084 43.3333C35.2084 41.8376 33.9959 40.625 32.5001 40.625Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                    <path d="M11.9167 10.8333C8.92513 10.8333 6.5 13.2584 6.5 16.2499V16.9615C6.5 18.5868 7.14564 20.1456 8.29493 21.2949L13 25.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M40.0833 10.8333C43.0749 10.8333 45.5 13.2584 45.5 16.2499V16.9615C45.5 18.5868 44.8543 20.1456 43.7051 21.2949L39 25.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                ...
                <div id="rightSide" class="col-12 col-lg-7 col-xl-8">
                    <div id="box3" class="box">
                        <h2>Inscripcion a competencias</h2>
                        <?php
                        $sql = "select * from viewcompetitionstoinscript";
                        $result = $conn->query($sql);
                        while($row = $result->fetch_assoc()){ $competitionContainer = $row['ID_competition']; ?>

                            <div class="lComp">
                                <div class="lCompMain" data-bs-toggle="collapse" data-bs-target="#lComp<?php echo($competitionContainer);?>">
                                    <div>
                                        <svg width="46" height="46" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18.6742 6.64575C16.0351 6.64575 13.8958 8.78513 13.8958 11.4242V24.1666C13.8958 32.5084 20.6581 39.2708 28.9999 39.2708C37.3418 39.2708 44.1041 32.5084 44.1041 24.1666V11.4242C44.1041 8.78513 41.9646 6.64575 39.3256 6.64575H18.6742Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                            <path d="M29 41.0833V43.4999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round"/>
                                            <path d="M36.2501 45.3125H21.7501C20.0817 45.3125 18.7292 46.665 18.7292 48.3333C18.7292 50.0017 20.0817 51.3542 21.7501 51.3542H36.2501C37.9184 51.3542 39.2709 50.0017 39.2709 48.3333C39.2709 46.665 37.9184 45.3125 36.2501 45.3125Z" stroke="#2BCCA2" stroke-width="1.5"/>
                                            <path d="M13.2917 12.0833C9.95495 12.0833 7.25 14.7882 7.25 18.1249V18.9186C7.25 20.7315 7.97014 22.4701 9.25204 23.752L14.5 28.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M44.7083 12.0833C48.045 12.0833 50.75 14.7882 50.75 18.1249V18.9186C50.75 20.7315 50.0298 22.4701 48.748 23.752L43.5 28.9999" stroke="#2BCCA2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <p><?php echo($row['name']);?></p>
                                    </div>
                                    <p><?php echo($row['date']);?></p>
                                </div>
                                <div class="lCompOpen collapse" id="lComp<?php echo($competitionContainer);?>">
                                    <form id="competitionForm<?php echo($competitionContainer);?>" class="auxiliar" spellcheck="false">
                                        <?php
                                        mysqli_next_result($conn);
                                        $eventsSql = "call possibleEvents(".$competitionContainer.",".$user['ID_athlete'].")";
                                        $eventsResult = $conn->query($eventsSql);
                                        if(mysqli_num_rows($eventsResult) > 0){
                                            while($eventRow = $eventsResult->fetch_assoc()){
                                                mysqli_next_result($conn);
                                                $checkInscriptSql = "select * from inscriptions where ID_athlete = " . $user['ID_athlete'] . " and ID_event = " . $eventRow['ID_event'];
                                                $checkInscriptResult = $conn->query($checkInscriptSql);
                                                if(mysqli_num_rows($checkInscriptResult) <= 0){?>
                                                    <div class="lCompItem">
                                                        <div class="lCompItemMain">
                                                            <div>
                                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M11 21H21" stroke="#edf2fb" stroke-width="1.5" stroke-linecap="round"/>
                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M16.8845 4.82378C15.5155 3.62383 13.4241 3.74942 12.2122 5.10499C12.2122 5.10499 6.18886 11.8419 4.10018 14.1803C2.00875 16.5174 3.54182 19.746 3.54182 19.746C3.54182 19.746 6.994 20.8285 9.05372 18.5242C11.1148 16.2198 17.1685 9.45019 17.1685 9.45019C18.3804 8.09462 18.2522 6.02372 16.8845 4.82378Z" stroke="#edf2fb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                    <path d="M10.3604 7.29248L14.9255 11.2792" stroke="#edf2fb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                </svg>
                                                                <p><?php echo($eventRow['name']);?></p>
                                                            </div>
                                                            <input type="checkbox" name="events<?php echo($competitionContainer);?>" id="form<?php echo($eventRow['ID_event']);?>" value="<?php echo($eventRow['ID_event']);?>"/>
                                                            <label class="eventItem" for="form<?php echo($eventRow['ID_event']);?>" data-bs-toggle="collapse" data-bs-target="#ItemForm<?php echo($eventRow['ID_event']);?>"><span>Seleccionar</span></label>
                                                        </div>
                                                        <div class="lCompItemOpen collapse" id="ItemForm<?php echo($eventRow['ID_event']);?>">
                                                            <div class="auxiliar2">
                                                                <p class="lCompItemTime">Horario <?php echo($eventRow['time']);?></p>
                                                                <p class="lCompItemRecord">
                                                                <?php 
                                                                if($eventRow['result'] == NULL){
                                                                    echo("sin marca");
                                                                }else{
                                                                    echo getTime($eventRow['result']);if($eventRow['campus'] == 0){echo('s');}else{echo('m');};   
                                                                }?>
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <?php } }?>
                                        <button type="button" onclick="newInscription(<?php echo($competitionContainer);?>)">Inscribirme</button>
                                        <?php }else{ ?>
                                            <h4>No hay ninguna prueba a la que te puedas inscribir.</h4>
                                        <?php } ?>
                                    </form>
                                </div>
                            </div>
    ...
    <script> <?php include('../../public/resources/js/competitionP.js'); ?> </script>
