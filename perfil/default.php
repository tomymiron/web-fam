...
?>
    ...
    <title>Perfil</title>
    <style><?php include('../public/resources/css/profile.css')?></style>
    <!-- SDN's -->
...
<body>
                    ...
                    <div id="box2" class="box">
                        ...
                        <div id="lastEventsContainer">
                            ...
                            if(mysqli_num_rows($result) > 0){
                                ...
                                <div class="lastEvents" data-bs-toggle="collapse" data-bs-target="#lastEvent<?php echo($row['ID_competitionlog']);?>">
                                    <div class="lastEventsMain">
                                        <p class="lastEventsMainItem"><?php echo($row['discipline']);?></p>
                                        <p><?php echo(getTime($row['result']));if($row['campus'] == 0){echo 's';}else{echo 'm';}?></p>
                                    </div>
                                    <div class="lastEventsOpen collapse" id="lastEvent<?php echo($row['ID_competitionlog']);?>">
                                        <div class="auxiliar">
                    ...
                    <div id="box5" class="box">
                        ...
                        <div id="seasonBestContainer" class="row">
                            ...
                            if(mysqli_num_rows($result) > 0){
                                        ...
                                        <div class="seasonBestItem col-6">
                                            <div class="seasonBestItemInner">
                                                    ...
                                                    <div class="seasonBestItem2">
                                                        <h4><?php echo($rowItem['result']);if($rowItem['campus'] == 0){echo 's';}else{echo 'm';}?></h4>
                                                    </div>
                                ...
                                echo "<h3 class='noResults'>No hay marcas registradas esta temporada.</h3>";
                            }
                            ?>
                        </div>
                    </div>
                ...
                <div id="rightSide" class="col-12 col-lg-7 col-xl-8">
                    <div id="box3" class="box">
                        <h2>Detalles de usuario</h2>
                            ...
                            <div class="col-12 col-md-6">
                                <p class="likeHeader">Nombre</p>
                                <p class="value"><?php echo($user['name'])?></p>
                                <p class="likeHeader">Email</p>
                                <p class="value"><?php echo($user['email'])?></p>
                            </div>
                            <div class="col-12 col-md-6">
                                <p class="likeHeader">Club</p>
                                <p class="value"><?php echo($user['club'])?></p>
                                <p class="likeHeader">Nacimiento</p>
                                <p class="value"><?php echo($user['born'])?></p>
                            </div>
                        </div>
                        <a href="mailto:tomymiron@gmail.com">Solicitar cambio</a>
                    </div>
                    <div id="box4" class="box">
                        <h2>Rankings <?php echo($user['category']);?></h2>
                        <div id="rankingItemsAuxiliar">
                                <?php
                                    ...
                                    if ($getDisciplinesResult->num_rows > 0) {
                                        ...
                                        echo "<h5 class='noResults'>No posee rankings.</h5>";
                                    }
                                ?>
                            </div>
                    </div>
                    <div id="box6" class="box">
                        ...
                        <div id="personalBestContainer" class="row">
                            <?php
                            mysqli_next_result($conn);
                            $sql = "select disciplines.ID_discipline from competitionlog left join events on events.ID_event = competitionlog.ID_event left join disciplines on disciplines.ID_discipline = events.ID_discipline where competitionlog.ID_athlete = '" . $user['ID_athlete'] . "' group by disciplines.ID_discipline;";
                            $result = mysqli_query($conn,$sql);
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    $resultItem = mysqli_query($conn,$query);
                                    while($rowItem = mysqli_fetch_array($resultItem)){ ?>
                                        <div class="personalBestItem col-6 col-lg-4 col-xl-3">
                                ...
                                echo "<h3 class='noResults'>No hay marcas registradas.</h3>";
                            }
                            ?>
                    </div>
                </div>
    ...
    <script> <?php include('../public/resources/js/profile.js'); ?> </script>
