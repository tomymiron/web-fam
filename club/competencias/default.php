...
?>
    ...
    <style><?php include('../../public/resources/css/clubCompetitions.css')?></style>
...
<body>
    ...
    <main>
        <aside id="menu">
            ...
            <a title="Competencias" class="option active" href="competencias">
                <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="leftSide" class="col-12 col-lg-5 col-xl-4">
                    ...
                    <div id="box1Content">
                        <div id="box1ContentAuxiliar">
                            <?php
                            $sql = "select * from pendingCompetitions";
                            $result = $conn->query($sql);
                            while($row = $result->fetch_assoc()){ 
                                $competitionContainer = $row['ID_competition'];
                                $inscriptions = "select inscriptions.ID_inscription, athletes.ID_athlete, group_concat(disciplines.name SEPARATOR' - ') as 'disciplines', athletes.name from inscriptions left join events on inscriptions.ID_event = events.ID_event left join disciplines on events.ID_discipline = disciplines.ID_discipline left join athletes on athletes.ID_athlete = inscriptions.ID_athlete where events.ID_competition = " . $competitionContainer . " and athletes.ID_club = " . $user['ID_club'] . " GROUP by athletes.ID_athlete order by inscriptions.ID_inscription DESC;";
                                mysqli_next_result($conn); 
                                $resultInscriptions = $conn->query($inscriptions);
                                if(mysqli_num_rows($resultInscriptions) > 0){ ?>
                                    ...
                                    <div class="pComp">
                                        <div class="pComp1">
                                            ...
                                            <div>
                                                <p class="pCompName"><?php echo($row['name']);?></p>
                                                <p class="pCompDate"><?php echo($row['date']);?></p>
                                            </div>
                                        </div>
                                        <div class="pComp2">
                                            <?php while($rowInscriptions = $resultInscriptions->fetch_assoc()){ ?>
                                            <p><?php echo($rowInscriptions['name'] . " | " . $rowInscriptions['disciplines']);?></p>
                                            <?php }?>
                                        </div>
                                    </div>
                            <?php }} ?>
    ...
    <script><?php include('../../public/resources/js/clubCompetitions.js'); ?></script>
