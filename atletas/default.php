...
<title>Athletas</title>
<style><?php include('../public/resources/css/homeAthletes.css')?></style>
...
<main>
    <section class="row">
        ...
        <div id="subHeader" class="row">
            <h1 class="col-12 col-md-6">Atletas</h1>
        ...
        <form method="GET" action="../../perfilAtleta/default.php" id="mainContent" class="row">
...
<script><?php include('../public/resources/js/homeAthletes.js');?></script>
